...
def get_style_img_path(style):
    return "artfilter/images/style/"+style+".jpg"


def main(style, style_weight=4, content_weight=1.0, tv_weight=1e-6, image_size=256):
    ...
    for x in datagen.flow_from_directory(
            train_image_path, class_mode=None, batch_size=train_batchsize, target_size=(
