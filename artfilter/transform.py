from tensorflow.python.keras.layers import Input, merge
...
from tensorflow.python.keras.optimizers import Adam, SGD,Nadam,Adadelta
...
def main(style='la_muse', output_file=None, input_file=None, original_color=0, blend_alpha=0.1, media_filter=3):
    ...
    model.load_weights('my_model.h5', by_name=False)
